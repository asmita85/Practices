...
//   - i.e. "Welcome to Pizza House, our toppings are: a, b, c, ..."
    ...
    listTopping(arr);
    console.log(message);
    document.getElementById(`h1Id`).innerHTML = welcome;
    document.getElementById(`h2Id`).innerHTML = message;
}
greetCustomer(); 
...
function printChecked(){
    ...
    selectedItems3=`your ` +selectedItems2+ ` pizza with : ` +selectedItems1+ ` coming up!`;
    selectedItems4=`your ` +selectedItems2+ ` pizza with : ` +selectedItems1+ ` coming up!`;

    alert(selectedItems3);
    document.getElementById("h3Id").innerHTML = `.....coming.....`;
    document.getElementById("id_of_div9").innerHTML = selectedItems4;
...
function ready(){
    ...
    selectedItems3=`your ` +selectedItems2+ ` pizza with : ` +selectedItems1+ ` is ready!`;
    selectedItems4=`your ` +selectedItems2+ ` pizza with : ` +selectedItems1+ ` coming up!`;

    alert(selectedItems3);
    document.getElementById("h4Id").innerHTML = `.....ready.....`;
}
